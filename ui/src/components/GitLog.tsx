...
import { PanelRightClose, GitCommitHorizontal, FileDiff } from 'lucide-react'
            ...
            {statusLoading ? (
              ...
              <div className="px-3 py-2 space-y-1">
                {statusFiles.map((file, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center gap-2 py-1.5 px-2 rounded-md hover:bg-accent/50 text-xs font-mono">
